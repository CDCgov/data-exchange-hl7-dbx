...
ev_name         ="hl7-message-processor-err"
ev_sas_key_name = os.getenv("v_eh_hl7_message_processor_err_key")
ev_sas_key_val = os.getenv("v_eh_hl7_message_processor_err_key_val")
...
tbl_name = "tbl_hl7_message_processor_err"
schema_name = db_name + "." + tbl_name
chkpoint_loc = "/tmp/delta/events/hl7-message-processor-err/_checkpoints/"
