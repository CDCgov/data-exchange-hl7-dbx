...
ev_name         ="hl7-mmg-sql-ok"
ev_sas_key_name = os.getenv("v_hl7_mmg_sql_ok_key")
ev_sas_key_val = os.getenv("v_hl7_mmg_sql_ok_key_val")
...
tbl_name = "tbl_hl7_mmg_sql_ok"
schema_name = db_name + "." + tbl_name
chkpoint_loc = "/tmp/delta/events/tbl_hl7_mmg_sql_ok/_checkpoints/"
