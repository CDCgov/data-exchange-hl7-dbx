...
ev_name         ="hl7-lake-segments-ok"
ev_sas_key_name = os.getenv("v_hl7_lake_segments_ok_key")
ev_sas_key_val = os.getenv("v_hl7_lake_segments_ok_key_val")
...
tbl_name = "tbl_hl7_lake_segments_ok"
schema_name = db_name + "." + tbl_name
chkpoint_loc = "/tmp/delta/events/tbl_hl7_lake_segments_ok/_checkpoints/"
...
# MAGIC %sql
# MAGIC SELECT count(*) FROM ocio_ede_dev.tbl_hl7_lake_segments_ok;
