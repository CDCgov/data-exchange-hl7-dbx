...
# MAGIC %fs
# MAGIC ls  dbfs:/tmp/delta/events/hl7_file_dropped

# COMMAND ----------

# MAGIC %fs 
# MAGIC ls 'abfss://ocio-dex-database@ocioededatalakedbr.dfs.core.windows.net/'

# COMMAND ----------

db_name ="ocio_ede_dev"
tbl_name = "tbl_hl7_file_dropped_test"
...
# MAGIC %fs
# MAGIC ls  'abfss://ocio-dex-database@ocioededatalakedbr.dfs.core.windows.net/checkpoint/tbl_hl7_file_dropped_test/'
