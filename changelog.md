...
### [0.0.31] 2023-11-01
	- Externalized maxEventsPerTrigger variable t the cluster level.

### [0.0.30] 2023-10-18

	- Fixed bug with status column on Validation Report.
	- Removed MMGs and elr event hubs due to clean up.
