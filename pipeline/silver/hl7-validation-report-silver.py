...
df4_structure = df3_structure.select('message_uuid','metadata_version',  'message_info', 'summary', 'provenance',  'status','config','error_concat.line','error_concat.column',df3_structure.error_concat.path.alias("field"),'error_concat.description','error_concat.classification','error_concat.category', 'process_name','lake_metadata')
...
df3_mmg = df2_mmg.select('message_uuid', 'metadata_version','message_info','summary', 'provenance','status','config','issue.line', 
                 df2_mmg.issue.path.alias("column"),df2_mmg.issue.fieldName.alias("field"),'issue.description','issue.classification', 'issue.category', 'process_name','lake_metadata' )
